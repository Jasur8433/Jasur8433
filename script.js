...
const i18n = {
  ...
  kk: {
    ...
    moodIcons: ['😀', '🙂', '😐', '🙁', '😡'],
    anonNote: 'Dáwıs anonim, tek ulıwma statistikada esaplanadı.',
    voteOk: 'Raxmet! Anonim baha qabul etildi.',
    voteTitle: 'Raxmet!',
    voteAccepted: 'Siziń bahańız qabul etildi',
    voteBody: 'Raxmet! Dáwısıńız ulıwma statistikaǵa qosıldı.',
    voteAlreadyTitle: 'Siz búrın dáwıs berdińiz',
